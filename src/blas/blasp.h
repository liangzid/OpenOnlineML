...
/*---------------------------------------------------------------------
I used it for basic operation.

Some example can be seen [here](https://www.jianshu.com/p/c479164cde61) 
for more information of BLAS library.
...
// output: float complex
// input: float complex vectors.
// cdot_c: dot product with complex vector: result=x^{H}\cdot Y  (H means 共轭转置)
fcomplex cdotc_(int *n, fcomplex *cx, int *incx, fcomplex *cy, int *incy);

// type: float complex
// input: float complex vectors.
// cdot_c: dot product with complex vector: result=x^{T}\cdot Y
fcomplex cdotu_(int *n, fcomplex *cx, int *incx, fcomplex *cy, int *incy);

//1-norm of single real(float)
float sasum_(int *n, float *sx, int *incx);

//1-norm of single complex(float)
float scasum_(int *n, fcomplex *cx, int *incx);

// 2-norm of single complex(float)
float scnrm2_(int *n, fcomplex *x, int *incx);

// dot product of single real(float)
float sdot_(int *n, float *sx, int *incx, float *sy, int *incy);

// 2-norm of single real(float)
float snrm2_(int *n, float *x, int *incx);

// dot product of vectors. {format double}
